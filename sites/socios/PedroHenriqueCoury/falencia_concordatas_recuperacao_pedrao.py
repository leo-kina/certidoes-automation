...
#python -m sites.socios.PedroHenriqueCoury.falencia_concordatas_recuperacao_pedrao
...
socio = SOCIOS_JSON["Pedro Coury"]
nome = socio["nome"]
cpf = socio["cpf"]
rg = socio['rg']
def emitir_falencia_concordatas_recuperacao(driver, url):
    driver.get(url)
    ...
    Select(select_tipo).select_by_value("58")
    time.sleep(1.2)
...
if __name__ == "__main__":
    ...
    emitir_falencia_concordatas_recuperacao(
        driver=driver,
